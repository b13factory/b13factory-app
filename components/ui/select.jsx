...
/**
 * Perbaikan:
 * - Ganti penggunaan `.props` yang salah menjadi `...props`
 * - Pastikan forwardRef menerima (props, ref)
 * - Tambahkan komponen pembantu (Item, Label, Separator, Scroll buttons, Content, etc.)
 * - Hilangkan background transparent di trigger (sesuai permintaan: jangan transparan dropdown)
 */
